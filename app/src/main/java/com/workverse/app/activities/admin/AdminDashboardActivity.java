...
public class AdminDashboardActivity extends AppCompatActivity {
    ...
    LinearLayout qaRoles,qaAddEmp,qaViewEmp,qaAddMgr,qaAttendance,qaLeave,qaPerformance,qaFeedback,qaSales;
    LinearLayout navHome,navNotif,navProfile,navLogout;
    FirebaseFirestore db; SharedPrefManager spm;
    @Override protected void onCreate(Bundle s){
        super.onCreate(s);
        setContentView(R.layout.activity_admin_dashboard);
        spm=SharedPrefManager.getInstance(this); db=FirebaseHelper.getDb();
        ...
        qaRoles=findViewById(R.id.qaRoles); qaAddEmp=findViewById(R.id.qaAddEmp);
        qaViewEmp=findViewById(R.id.qaViewEmp); qaAddMgr=findViewById(R.id.qaAddMgr);
        qaAttendance=findViewById(R.id.qaAttendance); qaLeave=findViewById(R.id.qaLeave);
        qaPerformance=findViewById(R.id.qaPerformance); qaFeedback=findViewById(R.id.qaFeedback);
        qaSales=findViewById(R.id.qaSales);
        navHome=findViewById(R.id.navHome); navNotif=findViewById(R.id.navNotif);
        navProfile=findViewById(R.id.navProfile); navLogout=findViewById(R.id.navLogout);
        qaRoles.setOnClickListener(v->go(ManageRolesActivity.class));
        qaAddEmp.setOnClickListener(v->go(AddEmployeeActivity.class));
        qaViewEmp.setOnClickListener(v->go(ViewEmployeesActivity.class));
        ...
        navNotif.setOnClickListener(v->go(AdminNotificationsActivity.class));
        navProfile.setOnClickListener(v->go(AdminProfileActivity.class));
