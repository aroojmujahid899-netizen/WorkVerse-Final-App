...
public class ManagerFeedbackActivity
    ...
    protected void onCreate(Bundle s) {
        ...
        // NO FAB — Manager sirf view karta hai
    ...
    private void loadData() {
        ...
        FirebaseHelper.getDb()
                .collection(FirebaseHelper.COL_FEEDBACK)
                .orderBy("timestamp",
                ...
                .addOnSuccessListener(snap -> {
                    ...
                    for (QueryDocumentSnapshot d : snap) {
                        Feedback f =
                                d.toObject(Feedback.class);
                        f.setId(d.getId());
                        // Sirf Employee feedback show karo
                        if ("Employee".equals(f.getRole()))
                            list.add(f);
                    }
