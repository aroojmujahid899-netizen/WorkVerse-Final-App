...
public class EmployeeDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle s) {
        ...
        LinearLayout qaFAQ           = findViewById(R.id.qaFAQ);   // NEW — FAQ button
        ...
        if (qaLeave         != null) qaLeave.setOnClickListener(v         -> startActivity(new Intent(this, ApplyLeaveActivity.class)));
        ...
        if (qaFAQ           != null) qaFAQ.setOnClickListener(v           -> startActivity(new Intent(this, ViewFAQActivity.class)));  // NEW

        if (navProfile != null)
            navProfile.setOnClickListener(v -> startActivity(new Intent(this, EmployeeProfileActivity.class)));
        ...
        if (uid != null) {
            FirebaseHelper.getDb().collection(FirebaseHelper.COL_ATTENDANCE)
                ...
                .addOnSuccessListener(snap -> {
                    if (tvPresent != null) tvPresent.setText(String.valueOf(snap.size()));
                });

            FirebaseHelper.getDb().collection(FirebaseHelper.COL_LEAVES)
                .whereEqualTo("userId", uid).get()
                .addOnSuccessListener(snap -> {
                    if (tvLeave != null) tvLeave.setText(String.valueOf(snap.size()));
                });
        }
    }
}
