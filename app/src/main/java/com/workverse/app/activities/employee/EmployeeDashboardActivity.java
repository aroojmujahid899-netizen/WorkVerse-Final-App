...
public class EmployeeDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout qaFaq = findViewById(R.id.qaFaq); // FAQ Binding Added
        ...
        if (qaFaq != null) qaFaq.setOnClickListener(v -> startActivity(new Intent(this, ViewFAQActivity.class))); // FAQ Click Listener Added
