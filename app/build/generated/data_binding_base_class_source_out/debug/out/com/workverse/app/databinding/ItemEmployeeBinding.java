...
public final class ItemEmployeeBinding implements ViewBinding {
  ...
  private ItemEmployeeBinding(@NonNull CardView rootView, @NonNull CircleImageView ivAvatar,
      @NonNull ImageView ivDelete, @NonNull ImageView ivEdit, @NonNull TextView tvDepartment,
      @NonNull TextView tvDesignation, @NonNull TextView tvName) {
  ...
  public static ItemEmployeeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEmployeeBinding((CardView) rootView, ivAvatar, ivDelete, ivEdit, tvDepartment,
          tvDesignation, tvName);
    }
